...
func newContext(conn net.Conn, localRW *bufio.ReadWriter, parent *Session, listenAddr *net.TCPAddr) (ctx *Context) {
	var contextID int64
	if parent == nil {
...
func newSession(ctx *Context, req *http.Request, listenAddr *net.TCPAddr) (sess *Session) {
